...
browse(community == "no") # 20 single-species studies

dictionary(treatment)
nrow( browse(treatment == "fire") ) # 21 fire studies

dictionary(studytype)
nrow( browse(studytype == "obs") ) # 78 observational studies
```
