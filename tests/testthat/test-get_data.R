...
test_that("concatenate_queries", {
  ...
  expect_true(inherits(popler:::concatenate_queries( poa_d ), 'call'))
  expect_true(inherits(popler:::concatenate_queries(pplr_browse(genus == "Poa")), 
                        "call"))
  expect_true(inherits(popler:::concatenate_queries(poa_d, year == 2000),
                       'call'))
  expect_true(inherits(popler:::concatenate_queries(pplr_browse(genus == "Poa"), 
                                                    year == 2000), 'call'))
  ...
  expect_error( popler:::concatenate_queries(poa_d, poa_d, poa_d) )
  expect_error( popler:::concatenate_queries(poa_d, duration_year == 5, obj))
  ...
  expect_error( popler:::concatenate_queries(poa_d, poa_d) )
  #4. any object that is not a popler object
  
  expect_error( popler:::concatenate_queries(poa_d, obj) )
